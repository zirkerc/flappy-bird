(() => {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        for (let i = 0; i < pipeCount; i++) {
            ...
            let manager = engine.addGameObject(new PipeManager(
                pipeSpeed,
                center,
                { x: pipeXGap, y: pipeYGap },
                pipeYRange,
                pipeYGapRange,
                i,
                pipeCount,
    ...
    class PipeManager extends GameObject {
        ...
        pipeYGap: number;
        pipeXGap: number;
        pipeYGapRange: number;
        pipeStart: number;

        constructor(speed: number, center: Vector, pipeGaps: Vector, pipeYRange: number, pipeYGapRange: number, index: number, pipeCount: number, top: Pipe, bottom: Pipe, callbacks?: GameObjectCallbacks) {
            super(callbacks);
    ...
    class Bird extends GameObject {
        ...
        drawDebug(ctx: CanvasRenderingContext2D, hasOverlapThisFrame: boolean): void {
